...
function Navbar() {
    ...
    return (
        <div style={{ backgroundImage: "url('./img/football1.jpg')", width: "100%", minheight: '45vw', backgroundPosition: 'center', backgroundSize: 'cover', backgroundRepeat: "no-repeat" }}>
            {
                click &&
                <div className='w-[100vw] h-[100vh] fixed z-[10] bg-[#00000059]' onClick={() => { setClick(false)}}></div>
            }
            {click ? <div className='fixed     w-[70%] z-[15] translate-x-0  ease-out transition-[.5s] min-h-screen bg-[#312f2fce]'></div> : <div className='absolute w-[70%] z-[10] transition-[.5s] ease-in min-h-screen translate-x-[-120%] bg-[#312f2fce]'></div>}
            <div className=' flex justify-center '>
                <div className={click ? 'flex md:justify-start  items-center md:w-[95%] w-[90%]' : 'flex md:justify-between  items-center md:w-[95%] w-[90%]'}>
                    {click ?
                        ''
                        :
                        <div className='flex md:items-center mt-[1rem] justify-center md:w-[20%] w-full md:justify-start  '>
                            <img src='./img/Deňizçi_topar.png' className='md:w-[15vw] w-[30vw] h-[25vw] mt-[-1rem] object-contain md:h-[15vw]' />
                    ...
                    <div className='flex items-center'>
                        <button onClick={() => {
                            ...
                            <img className={click ?
                                ...
                                :
                                'w-[10vw] z-[30] md:hidden block absolute top-5 left-6 h-[10vw] translate-x-0 ease-out transition-[.2s]'} src='./img/burger-bar.png' />

                        </button>
                        <ul className={click ? 'md:hidden   z-[20] w-full   mt-[5rem]' : 'md:flex z-[20]  hidden '}>
